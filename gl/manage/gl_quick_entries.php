...
if ($selected_id != -1)
{
	...
	if ($dim == 2)
		$th = array(_("Post"), _("Account/Tax Type"), _("Amount"), _("Memo"), _("Select Company"), _("Select Branch")." ", "", "");
	elseif ($dim == 1)	
		$th = array(_("Post"), _("Account/Tax Type"), _("Amount"), _("Memo"), _("Select Company"), "", "");
	else	
