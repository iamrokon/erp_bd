...
if ($dim == 2)
	$th = array(_("Journal Date"), _("Account Code"), _("Account Name"), _("Select Company")." ", _("Select Branch")." ",
		_("Debit"), _("Credit"), _("Memo"));
elseif ($dim == 1)
	$th = array(_("Journal Date"), _("Account Code"), _("Account Name"), _("Select Company"),
		_("Debit"), _("Credit"), _("Memo"));
else		
