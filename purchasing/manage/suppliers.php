...
//	table_section_title(_("Addresses & General"));
	text_row(_("Mailing Address:"), 'address', null, 35, 200);
	text_row(_("Physical Address:"), 'supp_address', null, 35, 200);

	text_row(_("General Notes:"), 'notes', null, 35, 200);
	text_row(_("VAT | GSTNo :"), 'gst_no', null, 42, 40);
	...
	table_section_title(_("Accounts (Please Do Not Change)"));
	...
	if ($dim >= 1)
	{
		...
		dimensions_list_row(_("Select Company")." :", 'dimension_id', null, true, " ", false, 1);
		if ($dim > 1)
			dimensions_list_row(_("Select Branch")." :", 'dimension2_id', null, true, " ", false, 2);
	}
	if ($dim < 1)
