...
function defaultCompany()
{
	...
	else
	{
    	...
    	if (@$SysPrefs->allow_password_reset) {
      		$demo_text = "<a href='$path_to_root/index.php?reset=1'>"._("Forgot Password ?")."</a>";
    	}
	}
	...
	//$welcome_text = "<p><h2>"._("Welcome to Boxygen ERP")."</h2></p>";
	//$welcome_text .= "<p>"._("Helps you connect with your business, take full control by tracking transactions in real-time.<br>It is as powerful as it is easy to use.")."</p>";
...
//		echo "<img src='$path_to_root/themes/shinee/images/logo.png'>";
//		echo $welcome_text;
//		echo "</div>";
	...
	if ($login_timeout) {
        ...
        //echo "</select>\n";
        echo "<select class='input' id='coy' name='company_name'>\n";
        echo "<option>" . $cName . "</option>";
        echo "</select>\n";
        echo "<input class='input' id='coy' name='company_login_name' type='hidden' value='$dbName' >";
	...
	echo "<button class='login-submit' type='submit' name='SubmitUser' title='Login'"
		." onclick='set_fullmode();'".(isset($blocked_msg) ? " disabled" : '')." ><i class = 'fa fa-angle-right fa-3x'></i></button>";
	echo "<a target=blank href='http://www.ngicon.com'>"._("Helpline: 0244806104 | 01933338968 | 01906630068 ")."</a>";
