...
function print_salesman_list()
{
	...
	while ($myrow=db_fetch($result))
	{
		...
		if (!$summary)
		{
			$myrow_d = get_customer_trans($myrow['trans_no'], ST_SALESINVOICE);
			$result_prev_due = get_due_to_cust_transactions_new($myrow_d['debtor_no']);
