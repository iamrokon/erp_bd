...
function print_invoices()
{
	...
	if($have_discount == 0){
		$cols = array(4, 20, 65, 250, 280, 300, 350, 420);
		...
		$cols = array(4, 20, 58, 220, 250, 268, 300, 325, 366, 420);
			// $headers in doctext.inc
...
//                        exit();
			...
			$summary_start_row = $rep->bottomMargin + (12.5 * $rep->lineHeight);
			...
			if($due_status == 1){
				$rep->NewLine();
				$rep->Font('normal');
				$rep->TextCol($bottomSectionPosition1, $bottomSectionPosition2, _("Past Due"), - 2);
				$rep->TextCol($bottomSectionPosition3, $bottomSectionPosition4, $prev_due, -2);
				$rep->NewLine();
				$rep->Font('bold');
