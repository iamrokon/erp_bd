...
if (isset($_GET['AddedID'])) {
	...
	display_note(print_document_link($dispatch_no, _("P&rint as Challan |  Packing Slip"), true, ST_CUSTDELIVERY, false, "printlink", "", 0, 1));
	display_note(print_document_link($dispatch_no, _("E&mail as Challan |  Packing Slip"), true, ST_CUSTDELIVERY, false, "printlink", "", 1, 1), 1);
	...
	display_note(print_document_link($delivery_no, _("P&rint as Challan |  Packing Slip"), true, ST_CUSTDELIVERY, false, "printlink", "", 0, 1));
	display_note(print_document_link($delivery_no, _("E&mail as Challan |  Packing Slip"), true, ST_CUSTDELIVERY, false, "printlink", "", 1, 1), 1);
...
if ($dim > 0) {
	start_row();
	label_cell(_("Select Company").":", "class='tableheader2'");
...
if ($dim > 1) {
	start_row();
	label_cell(_("Select Branch")." :", "class='tableheader2'");
