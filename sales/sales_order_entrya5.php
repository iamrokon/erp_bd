...
if (isset($_GET['AddedID'])) {
	...
	submenu_print(_("P&rint as Challan |  Packing Slip"), ST_CUSTDELIVERY, $delivery, 'prtopt', null, 1);
	submenu_print(_("E&mail as Challan |  Packing Slip"), ST_CUSTDELIVERY, $delivery, null, 1, 1);
	set_focus('prtopt');
	...
	submenu_print(_("&Print A5 Sales Invoice"), A5_ST_SALESINVOICE, $invoice."-".A5_ST_SALESINVOICE, 'prtopt');
	submenu_print(_("&Email Sales Invoice"), A5_ST_SALESINVOICE, $invoice."-".A5_ST_SALESINVOICE, null, 1);
	set_focus('prtopt');
